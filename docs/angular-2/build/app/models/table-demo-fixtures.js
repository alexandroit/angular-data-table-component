System.register([], function (exports_1, context_1) {
    ...
    exports_1("formatTotal", formatTotal);
    function formatRevenue(row) {
        return '$' + row.revenue.toLocaleString();
    }
    exports_1("formatRevenue", formatRevenue);
    ...
    exports_1("getOrderColumns", getOrderColumns);
    ...
    exports_1("getAdvancedColumns", getAdvancedColumns);
    function getHeaderGroupColumns() {
        return [
            {
                id: 'orderGroup',
                name: 'Order',
    ...
    exports_1("getHeaderGroupColumns", getHeaderGroupColumns);
    ...
    exports_1("getTicketColumns", getTicketColumns);
    ...
    exports_1("getInventoryColumns", getInventoryColumns);
    ...
    exports_1("getLockedColumns", getLockedColumns);
    function getRevenueColumns() {
        return [
    ...
    exports_1("getRevenueColumns", getRevenueColumns);
    function getWrappedColumns() {
        return [
    ...
    exports_1("getWrappedColumns", getWrappedColumns);
    ...
    exports_1("getLargeColumns", getLargeColumns);
    function buildLargeRows() {
        var rows = [];
    ...
    exports_1("buildLargeRows", buildLargeRows);
    function getLargeDataColumns() {
        return [
            { id: 'id', name: 'ID', selector: 'id', sortable: true, width: '90px' },
    ...
    exports_1("getLargeDataColumns", getLargeDataColumns);
    function buildLargePage(page, perPage, totalRows, sortField, sortDirection) {
        var rows = [];
    ...
    exports_1("buildLargePage", buildLargePage);
    function formatLargeAmount(row) {
        return '$' + row.amount.toLocaleString();
    }
    exports_1("formatLargeAmount", formatLargeAmount);
    ...
    function resolveLargeRowIndex(position, totalRows, sortField, sortDirection) {
        if ((sortField === 'id' || sortField === 'account') && sortDirection === 'desc') {
            return totalRows - 1 - position;
        }
        return position;
    }
    function cloneColumnVisibility(current, columnId, visible) {
        var next = {};
        var key;
        for (key in current) {
    ...
    exports_1("cloneColumnVisibility", cloneColumnVisibility);
    function dataSnippet(rows) {
        return JSON.stringify(rows, null, 2);
    }
    exports_1("dataSnippet", dataSnippet);
    var pageSizes, statusOptions, regionOptions, visibilityColumns, orders, tickets, inventory, lockedRows, revenue, longTextRows;
    return {
        setters: [],
        execute: function () {
            exports_1("pageSizes", pageSizes = [4, 5, 8, 10]);
            exports_1("statusOptions", statusOptions = ['', 'Paid', 'Pending', 'Review']);
            exports_1("regionOptions", regionOptions = ['', 'Argentina', 'Brazil', 'Canada', 'Chile', 'Colombia', 'Ecuador', 'Mexico', 'Peru', 'Portugal', 'United States', 'Uruguay']);
            exports_1("visibilityColumns", visibilityColumns = [
            ...
            exports_1("lockedRows", lockedRows = [
            ...
            exports_1("longTextRows", longTextRows = [
