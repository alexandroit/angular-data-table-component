System.register(["@angular/core", "../../shared/table-example-base", "./grouping.snippets", "../../services/table-demo-data.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, table_example_base_1, grouping_snippets_1, table_demo_data_service_1, GroupingExampleComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            GroupingExampleComponent = (function (_super) {
                ...
                function GroupingExampleComponent(demoData) {
                ...
                GroupingExampleComponent = __decorate([
                    core_1.Component({
                        ...
                        styleUrls: ['app/examples/grouping/grouping.component.css']
                    }),
