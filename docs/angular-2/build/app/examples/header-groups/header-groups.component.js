System.register(["@angular/core", "../../shared/table-example-base", "./header-groups.snippets", "../../services/table-demo-data.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, table_example_base_1, header_groups_snippets_1, table_demo_data_service_1, HeaderGroupsExampleComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            HeaderGroupsExampleComponent = (function (_super) {
                ...
                function HeaderGroupsExampleComponent(demoData) {
                ...
                HeaderGroupsExampleComponent = __decorate([
                    core_1.Component({
                        ...
                        styleUrls: ['app/examples/header-groups/header-groups.component.css']
                    }),
