System.register(["@angular/core", "@angular/common", "@stackline/angular-data-table-component", "../shared/example-shell.component", "../services/table-demo-data.service", "./accessibility-keyboard/accessibility-keyboard.component", "./basic/basic.component", "./cell-templates/cell-templates.component", "./client-pagination/client-pagination.component", "./column-filtering/column-filtering.component", "./column-ordering/column-ordering.component", "./column-pinning/column-pinning.component", "./column-sizing/column-sizing.component", "./column-visibility/column-visibility.component", "./conditional-styles/conditional-styles.component", "./dark/dark.component", "./dense/dense.component", "./disabled-selection/disabled-selection.component", "./empty/empty.component", "./expandable-rows/expandable-rows.component", "./expand-on-click/expand-on-click.component", "./faceting/faceting.component", "./fixed-header/fixed-header.component", "./global-filtering/global-filtering.component", "./grouping/grouping.component", "./header-groups/header-groups.component", "./headless-html/headless-html.component", "./headerless/headerless.component", "./image-cells/image-cells.component", "./kitchen-sink/kitchen-sink.component", "./large-data-pagination/large-data-pagination.component", "./loading/loading.component", "./multi-selection/multi-selection.component", "./programmatic-selection/programmatic-selection.component", "./responsive-wrap/responsive-wrap.component", "./row-events/row-events.component", "./row-pinning/row-pinning.component", "./server-pagination/server-pagination.component", "./single-selection/single-selection.component", "./sorting/sorting.component", "./virtual-rows/virtual-rows.component", "./visible-page-selection/visible-page-selection.component"], function (exports_1, context_1) {
    "use strict";
