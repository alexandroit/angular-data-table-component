...
const htmlFiles = ["docs-src/angular-15/src/index.html"];
const themeFiles = ["docs-src/angular-15/src/app/app.component.css"];
const expectedStrings = ["@stackline/angular-data-table-component"];
