...
class DataTableComponent {
    constructor() {
        ...
        this.trackByColumn = (index, column) => { var _a, _b; return (_b = (_a = column.id) !== null && _a !== void 0 ? _a : column.name) !== null && _b !== void 0 ? _b : index; };
    ...
    getHeaderStyle(column) {
        var _a, _b, _c;
        return Object.assign({ width: (_a = column.width) !== null && _a !== void 0 ? _a : null, minWidth: (_b = column.minWidth) !== null && _b !== void 0 ? _b : null, maxWidth: (_c = column.maxWidth) !== null && _c !== void 0 ? _c : null }, column.headerStyle);
    }
    getCellStyle(column) {
        var _a, _b, _c;
        return Object.assign({ width: (_a = column.width) !== null && _a !== void 0 ? _a : null, minWidth: (_b = column.minWidth) !== null && _b !== void 0 ? _b : null, maxWidth: (_c = column.maxWidth) !== null && _c !== void 0 ? _c : null }, column.style);
    }
    getWrapperClassName() {
    ...
    applyDefaultSort() {
        ...
        this.activeSortColumn = defaultColumn !== null && defaultColumn !== void 0 ? defaultColumn : this.activeSortColumn;
...
DataTableModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.10", ngImport: i0, type: DataTableModule, declarations: [DataTableComponent], imports: [CommonModule], exports: [DataTableComponent] });
DataTableModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: DataTableModule, imports: [CommonModule] });
